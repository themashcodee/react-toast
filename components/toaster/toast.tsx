...
export const Toast = memo(forwardRef<HTMLLIElement, P>((({ index, toast, top }, ref) => {
    ...
    return (
        <motion.li
            ...
            initial={{ bottom: 0 }}
            animate={controls}
            exit={{ bottom: -top, opacity: 0, scale: .2 }}
        ...
        >
            <span className='w-6 h-6 relative shrink-0'>
                <Image src={icons[toast.type]} alt="success" layout="fill" objectFit='contain' />
            </span>
